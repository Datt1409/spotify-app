...
export default function Sidebar() {
  ...
  return (
    <div className="text-gray-500 p-5 pb-36 text-xs lg:text-sm border-r border-gray-900 overflow-y-scroll h-screen scrollbar-hide sm:max-h-[12rem] lg:max-h-[15rem] hidden md:inline-flex">
